...
import { crypt } from "crypt3-md5"; // Správný balíček pro MD5 crypt s prefixem $1$
...
export async function loginToWebshare(username, password) {
    ...
    // Správné hashování: crypt3-md5 s prefixem $1$ a solem "webshare"
    const md5hash = crypt(password, "$1$webshare$");
